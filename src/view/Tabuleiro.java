...
public class Tabuleiro extends JFrame implements Observer {
	...
	public void update(Observable o, Object arg) {
		...
		repaint();
		if (controller.getJogadaAtual()!=null && controller.getJogadorDaVez()!=null && controller.getJogadorDaVez().getLstCartas().size() > 4 && controller.getJogadaAtual().getNome().equals("Distribuir")) {
			pnlModalCartas.setVisible(true);
		}
